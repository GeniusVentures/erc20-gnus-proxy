# ERC20-GNUS-Proxy DevContainer

A comprehensive, reproducible development environment for the ERC20-GNUS-Proxy Ethereum smart contract project using ERC-2535 Diamond Proxy Standard.
...
1. **Clone the repository**:
   ...
   ```bash
   git clone https://github.com/GeniusVentures/erc20-gnus-proxy.git
   cd erc20-gnus-proxy
   ```
...
ERC20-GNUS-Proxy uses ERC-2535 Diamond Proxy Standard for upgradeable contracts:
...
This DevContainer configuration is part of the ERC20-GNUS-Proxy project. See project LICENSE for details.
