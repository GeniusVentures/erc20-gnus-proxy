...
class SecurityMonitoringWebhook {
  ...
  private async handleSecretScanningAlert(
    ...
    const alert: SecretScanningAlert =
      payload.alert as unknown as SecretScanningAlert;
  ...
  private async handleCodeScanningAlert(
    ...
    const alert: CodeScanningAlert =
      payload.alert as unknown as CodeScanningAlert;
    const severity: string = this.mapSeverity(
  ...
  private async handleWorkflowRun(
    ...
    const workflow: WorkflowRun =
      payload.workflow_run as unknown as WorkflowRun;
...
class MetricsCollector {
  ...
  private determineSeverity(
    ...
    switch (eventType) {
      ...
      case "dependabot_alert":
        return (
          (payload as any).alert?.security_vulnerability?.severity || "medium"
        );
      default:
        return "medium";
    }
